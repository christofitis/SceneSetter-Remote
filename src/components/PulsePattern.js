...
export default function Pulse(props) {
    ...
    return (
        <div>
            ...
            <NumberSlider label={"Speed: " + currentPatternData['speed_max']} width={300} height={0} orientation="horizontal" color="" size="medium" min={1} max={5000} defaultValue={props.currentPatternData['speed_max']} setValue={(e) => setCurrentPatternData({...currentPatternData, 'speed_max':e/1000})}></NumberSlider>
